...
function onSay(player, words, param)
	...
	db.query("INSERT INTO `account_bans` (`account_id`, `reason`, `expires_at`, `banned_by`) VALUES (" ..
			accountId .. ", " .. db.escapeString(reason) .. ", DATE_ADD(NOW(), INTERVAL " .. banDays .. "DAY), " .. player:getGuid() .. ")")
