...
CREATE TABLE IF NOT EXISTS `player_namelocks` (
  ...
  `reason` varchar(255) NOT NULL,
  `namelocked_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `houses` (
  ...
  `bid` unsigned int(11) NULL,
  `bid_end` TIMESTAMP NULL,
  `last_bid` unsigned int(11) NULL,
  `highest_bidder` int(11) NULL,
